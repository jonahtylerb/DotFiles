# Generated by Powerlevel10k configuration wizard on 2025-05-05 at 11:58 EDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      if [[ $branch == */* ]]; then
        local username=${branch%%/*}
        local branch_name=${branch#*/}
        branch="${username[1,2]}/${branch_name}"
      fi
  ...
  typeset -g POWERLEVEL9K_AWS_DEV_CONTENT_EXPANSION='> ${P9K_CONTENT} <'
